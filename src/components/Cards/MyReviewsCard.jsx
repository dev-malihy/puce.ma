  ...
  return (
    <>
      <div className="reviewCardWrapper">
          ...
          <div className="reviewerDetails">
            <div className="user_chat_tab_img_cont">
              ...
              <Image
                width={36}
                height={36}
                src={rating?.item?.image || placeholder_image}
              ...
              <div className="reviewStarTimeCont">
                <div className="reviewStarsCont">
                  <Rate
                    ...
                    className="reviewerStarRating reviewerStarRating"
                  />
        ...
        <p
          className={`reviewContent ${isExpanded ? "expanded" : "collapsed"}`}
          ref={contentRef}
        >
          {rating?.review}
        </p>
