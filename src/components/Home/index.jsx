...
import { SliderData, setSlider } from "@/redux/reducer/sliderSlice";
...
import { getKilometerRange } from "@/redux/reducer/locationSlice";
  ...
  useEffect(() => {
    const fetchFeaturedSectionData = async () => {
      ...
      try {
        ...
        const { data } = response.data;
        console.info("Featured Data:", data);
