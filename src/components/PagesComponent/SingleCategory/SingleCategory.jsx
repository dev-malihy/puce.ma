...
import { SearchData } from "@/redux/reducer/searchSlice";
...
import {
  ...
  ViewCategory,
  setCategoryView,
  setSingleCatCurrentPage,
  setSingleCatItem,
  setSingleCatLastPage,
...
const SingleCategory = ({ slug }) => {
  ...
  useEffect(() => {
    if (BreadcrumbPath?.length === 2) {
      ...
      setTitle(
        `${BreadcrumbPath[BreadcrumbPath.length - 1]?.name} in ${
          BreadcrumbPath[BreadcrumbPath.length - 2]?.name
        }`
      );
    }
  }, [BreadcrumbPath]);
  ...
  const postedSince =
    DatePosted === "all-time"
      ...
      : DatePosted === "today"
      ? t("today")
      : DatePosted === "within-1-week"
      ? t("within1Week")
      : DatePosted === "within-2-week"
      ? t("within2Weeks")
      : DatePosted === "within-1-month"
      ? t("within1Month")
      : DatePosted === "within-3-month"
      ? t("within3Months")
      : "";
  const isClearAll =
            ...
            <div className="row" id="main_row">
              <div className="col-12 col-md-6 col-lg-3" id="filter_sec">
                <FilterCard
                  ...
                  setIsFetchSingleCatItem={setIsFetchSingleCatItem}
                  ...
                  setIsShowBudget={setIsShowBudget}
                  ...
                  setIsShowExtraDet={setIsShowExtraDet}
                  setIsShowKmRange={setIsShowKmRange}
                  treeData={treeData}
                />
              </div>
                ...
                <div className="filter_header">
                  <div className="filterList">
                    ...
                    {IsShowBudget && (
                      <div className="filter_item">
                        <span>
                          {t("budget")}: {MinMaxPrice.min_price}-
